...
type OrderRepository interface {
	...
	FindAll(ctx context.Context, merchantId, customerId uint64, limit, offset int) ([]entities.Order, error)
	FindOneById(ctx context.Context, id uint64) (*entities.Order, error)
	...
	Count(ctx context.Context, merchantId, customerId uint64) (int64, error)
}
...
func (r *orderRepository) FindAll(ctx context.Context, merchantId, customerId uint64, limit, offset int) ([]entities.Order, error) {
...
func (r *orderRepository) FindOneById(ctx context.Context, id uint64) (*entities.Order, error) {
...
func (r *orderRepository) Count(ctx context.Context, merchantId, customerId uint64) (int64, error) {
	var count int64
