...
type Message struct {
	...
	ConversationID uint64       `gorm:"not null;index:idx_messages_conversation_id" json:"conversation_id"`
	...
	SenderID       *uint64      `gorm:"index:idx_messages_sender_type_sender_id,priority:2" json:"sender_id,omitempty"`
