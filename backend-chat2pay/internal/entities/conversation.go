...
type Conversation struct {
	...
	CustomerID *string   `gorm:"index:idx_conversations_customer_id" json:"customer_id,omitempty"`
	MerchantID string    `gorm:"not null;index:idx_conversations_merchant_id" json:"merchant_id"`
